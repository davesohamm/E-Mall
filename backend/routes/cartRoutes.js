...
// @route PUT /api/cart
// @desc Update product quantity in the cart for a guest or a user
// @access Public
        ...
        if (userCart) {
            ...
            guestCart.products.forEach((guestItem) => {
                ...
                if (productIndex > -1) {
                    ...
                    // otherwise, add guest item into the cart
            ...
            if (userCart) {
                // if the guest cart is already merged, return user cart
