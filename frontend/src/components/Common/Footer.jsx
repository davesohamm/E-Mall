    ...
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-16">
      ...
      <div>
        ...
        <div className="flex items-center space-x-5 mb-6">
          <a href="https://github.com/davesohamm" target="_blank" rel="noopener noreferrer" className="hover:text-gray-500">
        ...
        <p>
          <FiPhoneCall className="inline-block mr-2"/>+919714028127</p>
      </div>
    </div>
    {/*  Footer Bottom */}
    <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
      <p className="text-gray-500 text-sm tracking-tighter text-center">© 2025, Soham Dave. All Rights Reserved.</p>
    </div>
  </footer>
